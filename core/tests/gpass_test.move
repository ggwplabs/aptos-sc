...
module ggwp_core::gpass_test {
    ...
    public entry fun freeze_tokens(core_signer: &signer, ggwp_coin: &signer, accumulative_fund: &signer, user1: &signer, user2: &signer) {
        genesis::setup();
    ...
    // TODO: withdraw_gpass, unfreeze_tokens tests
}
